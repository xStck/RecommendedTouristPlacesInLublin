...
struct LoginView: View {
    ...
    private func addData(viewContext: NSManagedObjectContext){
        if(users.isEmpty && categories.isEmpty && opinions.isEmpty && places.isEmpty){
            ...
            addCategoryItemsToDB(viewContext: viewContext, categoryName: "Zabytki", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLattitudeArr: placeLattitudeArr)
            ...
            addCategoryItemsToDB(viewContext: viewContext, categoryName: "Restauracje", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLattitudeArr: placeLattitudeArr)
            ...
            addCategoryItemsToDB(viewContext: viewContext, categoryName: "Kina", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLattitudeArr: placeLattitudeArr)
            ...
            addCategoryItemsToDB(viewContext: viewContext, categoryName: "Teatry", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLattitudeArr: placeLattitudeArr)
