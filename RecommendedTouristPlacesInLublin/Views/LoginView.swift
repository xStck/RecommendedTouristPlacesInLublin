...
struct LoginView: View {
    ...
    private func addData(){
        if(users.isEmpty && categories.isEmpty && opinions.isEmpty && places.isEmpty){
            ...
            var placeLattitudeArr: [String] = ["51.24513945062349","51.246899237466", "51.24686560691351"]
            var placeLongitudeArr: [String] = ["22.56628734638244", "22.568356426400396", "22.566617811484523"]
            addCategoryItemsToDB(categoryName: "Zabytki", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLatitudeArr: placeLattitudeArr)
            ...
            addCategoryItemsToDB(categoryName: "Restauracje", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLatitudeArr: placeLattitudeArr)
            ...
            addCategoryItemsToDB(categoryName: "Kina", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLatitudeArr: placeLattitudeArr)
            ...
            addCategoryItemsToDB(categoryName: "Teatry", placeNameArr: placeNameArr, placeDescArr: placeDescArr, placeLongitudeArr: placeLongitudeArr, placeLatitudeArr: placeLattitudeArr)
